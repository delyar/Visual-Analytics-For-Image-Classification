								...
								{#each {length:10} as _,j}
									...
									{#each row.bins[j]["instances"] as binInstance,z}
										{#if z < 8}
											...
											<rect x="{axisLeftmargin + ((binInstance.binToBelong/numBins)*axisWidth) + (z*9)}" y="{(i)*verticalSpace + 50}" width="9" height="9" fill='{colorScale(binInstance["true_label"])}' class="{selectedPoint == undefined && highlightedlabeldAsGroup == undefined && highlightedPredictedAsGroup==undefined? "regular_box": (selectedPoint == binInstance.id || highlightedlabeldAsGroup==binInstance.true_label || highlightedPredictedAsGroup==binInstance.predicted_label? "highlight_box": "unHighlight_box")}"
											on:mouseenter={()=>{
										...
										{:else if z> 7 && z<16}
											...
											<rect x="{axisLeftmargin + ((binInstance.binToBelong/numBins)*axisWidth) + ((z-8)*9)}" y="{(i)*verticalSpace + 42}" width="9" height="9" fill='{colorScale(binInstance["true_label"])}' class="{selectedPoint == undefined && highlightedlabeldAsGroup == undefined && highlightedPredictedAsGroup==undefined? "regular_box": (selectedPoint == binInstance.id || highlightedlabeldAsGroup==binInstance.true_label || highlightedPredictedAsGroup==binInstance.predicted_label? "highlight_box": "unHighlight_box")}"
											on:mouseenter={()=>{
												handleMouseEnter(binInstance);
											}}
											on:mouseleave={()=>{
										...
										{:else if z>15 && z<24}
											...
											<rect x="{axisLeftmargin + ((binInstance.binToBelong/numBins)*axisWidth) + ((z-16)*9)}" y="{(i)*verticalSpace + 34}" width="9" height="9" fill='{colorScale(binInstance["true_label"])}' class="{selectedPoint == undefined && highlightedlabeldAsGroup == undefined && highlightedPredictedAsGroup==undefined? "regular_box": (selectedPoint == binInstance.id || highlightedlabeldAsGroup==binInstance.true_label || highlightedPredictedAsGroup==binInstance.predicted_label? "highlight_box": "unHighlight_box")}"
											on:mouseenter={()=>{
												handleMouseEnter(binInstance);
											}}
											on:mouseleave={()=>{
										...
										{:else if z>23 && z<32}
											...
											<rect x="{axisLeftmargin + ((binInstance.binToBelong/numBins)*axisWidth) + ((z-24)*9)}" y="{(i)*verticalSpace + 26}" width="9" height="9" fill='{colorScale(binInstance["true_label"])}' class="{selectedPoint == undefined && highlightedlabeldAsGroup == undefined && highlightedPredictedAsGroup==undefined? "regular_box": (selectedPoint == binInstance.id || highlightedlabeldAsGroup==binInstance.true_label || highlightedPredictedAsGroup==binInstance.predicted_label? "highlight_box": "unHighlight_box")}"
											on:mouseenter={()=>{
												handleMouseEnter(binInstance);
											}}
											on:mouseleave={()=>{
										...
										{:else if z>31 && z<40}
											...
											<rect x="{axisLeftmargin + ((binInstance.binToBelong/numBins)*axisWidth) + ((z-32)*9)}" y="{(i)*verticalSpace + 18}" width="9" height="9" fill='{colorScale(binInstance["true_label"])}' class="{selectedPoint == undefined && highlightedlabeldAsGroup == undefined && highlightedPredictedAsGroup==undefined? "regular_box": (selectedPoint == binInstance.id || highlightedlabeldAsGroup==binInstance.true_label || highlightedPredictedAsGroup==binInstance.predicted_label? "highlight_box": "unHighlight_box")}"
											on:mouseenter={()=>{
												handleMouseEnter(binInstance);
											}}
											on:mouseleave={()=>{
										...
										{:else}
											...
											<rect x="{axisLeftmargin + ((binInstance.binToBelong/numBins)*axisWidth) + ((z-40)*9)}" y="{(i)*verticalSpace + 10}" width="9" height="9" fill='{colorScale(binInstance["true_label"])}' class="{selectedPoint == undefined && highlightedlabeldAsGroup == undefined && highlightedPredictedAsGroup==undefined? "regular_box": (selectedPoint == binInstance.id || highlightedlabeldAsGroup==binInstance.true_label || highlightedPredictedAsGroup==binInstance.predicted_label? "highlight_box": "unHighlight_box")}"
											on:mouseenter={()=>{
												handleMouseEnter(binInstance);
											}}
											on:mouseleave={()=>{
